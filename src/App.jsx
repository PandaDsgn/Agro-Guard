    ...
    <div className="card gauge-card">
      ...
      <div className="gauge-wrapper">
        <div
          ...
          style={{
            background: `conic-gradient(${color} ${rotation}deg, #1e293b 0deg)`,
          }}
        >
...
const DiagnosticPanel = ({ status, recommendation, color }) => {
  return (
    <div
      className="card diagnostic-card"
      style={{ borderLeft: `4px solid ${color || "#64748b"}` }}
    >
      <div className="diagnostic-header">
        <div>
          <h3 className="card-title">ML PREDICTIVE DIAGNOSTIC</h3>
          <div className="diagnostic-status" style={{ color: color }}>
            {status || "INITIALIZING..."}
          </div>
        </div>
      </div>
      ...
      <div className="ai-console">
        ...
        <div className="console-text">
          {recommendation || "Waiting for Python Backend..."}
        </div>
      </div>
    </div>
  );
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(
          `https://pandadsgn-agro-guard-api.hf.space/data?fruit=${selectedFruit}`,
        );
    ...
    <div className="app-shell">
      ...
      <aside className="sidebar">
        <div className="brand">
          ...
          <h1>
            AGRO-GUARD <span className="lite">ML</span>
          </h1>
        </div>

        <nav style={{ marginTop: "40px" }}>
          <div className="console-label" style={{ padding: "0 15px" }}>
            SELECT STORAGE CROP
          </div>
          <select
            value={selectedFruit}
      ...
      <main className="main-content">
        {data.is_anomaly && (
          <div className="anomaly-banner">
            ⚠️ CRITICAL ANOMALY: SENSOR INTERFERENCE DETECTED
          </div>
        )}
        ...
        <div className="dashboard-grid">
          ...
          <section className="card silo-section">
            ...
            <div className="silo-graphic">
              <div
                className="liquid"
                style={{ height: `${data.inventory}%`, background: data.color }}
              ></div>
            ...
            <div className="metric-overlay">
              ...
              <div className="forecast-box">
                ...
                <span className="value" style={{ color: data.color }}>
